Project Elk consists of building out a cloud network in Azure for a web application and setting up an ELK stack server to monitor its network traffic. The deployed and configured ELK stack utilized Filebeat and Metricbeat data collection tools for log analysis.
